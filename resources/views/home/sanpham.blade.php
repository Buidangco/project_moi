                ...
                <div class="container-fluid dashboard-content ">
                    ...
                    <div class="ecommerce-widget">
                        ...
                        <div class="text-center">
                         <a href="/home/add" class="btn btn-default btn-rounded mb-4"  >Thêm sản phẩm</a>
                        </div>
                        <div class="row">
                            <!-- ============================================================== -->
                                            ...
                                            <table class="table">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td>1</td>
                                                        <td>
                                                            <div class="m-r-10"><img src="assets/images/{{$row->image}}" alt="user" class="rounded" width="45"></div>
                                                        </td>
                                                        <td>{{$row->name}} </td>
                                                        ...
                                                        <td><a href="" class="btn btn-default btn-rounded mb-4"><i class="fas fa-trash-alt"></i></a>
                                                        </td>
                                                    </tr>
                                                    @endforeach
                                                    <tr>
