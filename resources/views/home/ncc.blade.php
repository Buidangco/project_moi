       ...
       @section('section')
        ...
        <div class="dashboard-wrapper">
         ...
         <div style="display: flex;">
                                      <a style="    width: 175px;    padding: 10px;margin-left: 73px;    height: 44px;" class="btn btn-primary btn-lg" data-toggle="modal" data-target="#ModalLoginForm" >Thêm nhà cung cấp</a>
                                          ...
                                          <table class="table sparkle-table  " style="height: 600px;color: azure;font-size: 22px;">
                                                <thead class="bg-light">
                                                    <tr style="    font-size: 25px;background-color: #2a4d69;">
                                                        <th style="padding: 23px;font-family: cursive;font-weight: 800;color: aliceblue;">STT</th>                                                        <th style="padding: 23px;font-family: cursive;font-weight: 800;color: aliceblue;">Tên nhà cung cấp</th> 
