...
<!--       <table class="table table-bordered" style="width: 1142px;    color: brown;">
  <thead>
    <tr style="    font-size: 25px;background: #2a4d69;">
      ...
      <th style="color: aliceblue;font-size: 21px;text-align: center;text-align: center;">Số điện thoại</th>
...
<div class="row" style="height: 500px;
  ...
  <div class="col-3" style="  margin-top: 13px;
    ...
    <div style="display: flex;">
      <p>Họ tên</p>
      <span id="tenKH" style="    margin-left: 19px;font-size: 20px;color: lightyellow;">{{$value->tenKH}}</span>
    </div>
     <div style="display: flex;">
      <p >Số điện thoại</p>
      <span id="sdt" style="    margin-left: 19px;font-size: 20px;color: lightyellow;">{{$value->sdt}}</span>
    </div>
     <div style="display: flex;">
      <p>Email</p>
      <span id="email" style="    margin-left: 19px;font-size: 20px;color: lightyellow;">{{$value->email}}</span>
    </div>
     <div style="display: flex;">
      <p>Ngày mua</p>
      <span style="    margin-left: 19px;font-size: 20px;color: lightyellow;">{{$value->ngayban}}</span>
    </div>
     <div style="opacity: 0;display: none;">
      <p>{{$value->mahoadon}}</p>
       <p>{{$value->id}}</p>
      <span style="    margin-left: 19px;font-size: 20px;color: lightyellow;">{{$value->makh}}</span>
    </div>
     <div style="display: flex;">
      <p>Số lượng</p>
      <span style="    margin-left: 19px;font-size: 20px;color: lightyellow;">{{$value->tongsl}}</span>
    </div>
     <div style="display: flex;">
      <p>Giá</p>
      <span style="    margin-left: 19px;font-size: 20px;color: lightyellow;">{{number_format($value->gia)}}đ</span>
    </div>
  ...
  @endforeach
    ...
    <div class="tab-pane" id="tab1" style="width: 100%;    margin-top: 32px;">
<!--       <table class="table table-bordered" style="width: 1142px;    color: brown;">
  <thead>
    <tr style="    font-size: 25px;background: #2a4d69;">
      <th style="color: aliceblue;font-size: 21px;text-align: center;">STT</th>
      <th style="color: aliceblue;font-size: 21px;text-align: center;">Tên</th>
      <th style="color: aliceblue;font-size: 21px;text-align: center;">Số điện thoại</th>
      <th style="color: aliceblue;font-size: 21px;text-align: center;">email</th>
      <th style="color: aliceblue;font-size: 21px;text-align: center;">Số lượng</th>
      <th style="color: aliceblue;font-size: 21px;text-align: center;">Giá</th>
    </tr>
 ...
 -->      <div class="row" style="height: 500px;
  ...
  @endforeach
        ...
        <div class="tab-pane active" id="tab5" style="width: 100%">
      <div class="row" style="height: 500px;
    overflow: auto;margin-left: 12px;">
  @foreach($dagiao as $value)
  <div class="col-3" style="  margin-top: 13px;
    border: 1px solid black;    padding: 10px;
    margin-left: 5px;background: darkgray;">
    <div style="display: flex;">
  ...
  @endforeach
    ...
    <div class="tab-pane" id="tab6" style="width: 100%;    margin-top: 32px;">
<!--       <table class="table table-bordered" style="width: 1142px;    color: brown;">
  <thead>
    <tr style="    font-size: 25px;background: #2a4d69;">
      <th style="color: aliceblue;font-size: 21px;text-align: center;">STT</th>
