                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-7 col-sm-7 col-xs-12"> 
                                        <div class="single-product-info">
                                            ...
                                            <div class="pro-price" style="display: flex;"> <h4 class="pro-price">Giá : {{number_format($ct->price)}}đ</h4>
                                                <h4 style="margin-left: 20px; text-decoration: line-through;opacity: 0.7" class="pro-price">{{number_format(($ct->price)+($ct->price)/($ct->sale))}}đ</h4>
                                            </div>
                                                ...
                                                <div role="tabpanel" class="tab-pane" id="reviews">
                                                    ...
                                                    <div class="reviews-tab-desc">
                                                       ...
                                                       <!--  <div class="media mt-30">
                                                        ...
                                                        <div id="binhluan" style="    height: 312px;overflow: auto;">
                                                            @if($binhluan!=null)
